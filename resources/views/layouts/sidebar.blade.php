    <div class="choose-layout-area">
        ...
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="choose-layout" id="chooseLayout" style="overflow: hidden; width: auto; height: 100%;">
        ...
        </div><div class="slimScrollBar" style="background: rgb(140, 140, 140); width: 2px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 0px; height: 692.198px;"></div><div class="slimScrollRail" style="width: 2px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 0px;"></div></div>
    </div>
    ...
    ******* Page Wrapper Area Start **********
    ...
    <div class="ecaps-page-wrapper">
        ...
        <div class="ecaps-sidemenu-area">
            ...
            <!-- Side Nav -->
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="ecaps-sidenav" id="ecapsSideNav" style="overflow: hidden; width: auto; height: 100%;">
                <!-- Side Menu Area -->
                <div class="side-menu-area">
                    ...
                    <nav>
                        <ul class="sidebar-menu tree" data-widget="tree">
                            ...
                            <li><a href="{{ url('home/about')}}"><i class="icon_cog"></i> <span>About</span></a></li>
                            <li class="treeview">
            ...
            </div><div class="slimScrollBar" style="background: rgb(156, 156, 156); width: 3px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 0px; height: 399.151px;"></div><div class="slimScrollRail" style="width: 3px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 0px;"></div></div>
        </div>